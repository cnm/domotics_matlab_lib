...
public class GetOperators{
	...
	public static Map<String,String> readDevice(String json,Integer id){
		...
		for(JsonElement object: deviceObjectArray){
				...
				JsonObject deviceProperties = jso.getAsJsonObject("DeviceProperties");

				Set<Map.Entry<String,JsonElement>> set = deviceProperties.entrySet();  //device properties SET
				
				for(Map.Entry<String,JsonElement> entry : set){
					JsonElement prop = entry.getValue();
